 ...
 * {Diff(Operation.DiffOperationDelete, "Hello"),
 *  Diff(Operation.DiffOperationInsert, "Goodbye"),
 *  Diff(Operation.DiffOperationEqual, " world.")}
 * which means: delete "Hello", add "Goodbye" and keep " world."
 */

typedef NS_ENUM(NSInteger, DiffOperation) {
    DiffOperationDelete,
    DiffOperationInsert,
    DiffOperationEqual
};
...
@interface Diff : NSObject <NSCopying> {
  DiffOperation operation;  // One of: DiffOperationInsert, DiffOperationDelete or DiffOperationEqual.
